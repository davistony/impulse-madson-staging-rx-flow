...
(function(){
 ...
 class CountdownTimer extends HTMLElement {
  constructor() {
    ...
    this.hideTimerOnComplete = this.el.dataset.hideTimer;
    this.completeMessage = this.el.dataset.completeMessage;
    this.resetCounter = this.el.dataset.resetCounter; // New property for reset counter checkbox
  ...
  _calculate() {
    ...
    if (timeDifference > 0) {
      ...
      if (this.resetCounter === 'true') { // Check if reset counter checkbox is checked
        this._resetTimer(); // Reset the timer
      } else {
        this.timerComplete = true; // Mark timer as complete
      }
    }
  }

  _resetTimer() {
    // Reset timer for another 23 hours and 59 minutes
